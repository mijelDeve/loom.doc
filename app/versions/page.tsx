      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Seguimiento de cambios y actualizaciones de Markdaun
          </p>
          <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">
            Datos obtenidos automáticamente desde GitHub
          </p>
        </div>
        ...
        <div className="mt-8 p-6 bg-primary-50 dark:bg-primary-900/20 rounded-xl border border-primary-100 dark:border-primary-800">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Estamos trabajando en nuevas características. ¡Mantente atento a las actualizaciones!
          </p>
        </div>
      </div>
    </div>
