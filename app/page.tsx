...
const features = [
  {
    ...
    description: 'Editor de Markdown con vista dividida, scroll sincronizado y soporte GFM completo.',
  },
  {
    icon: Layers,
    title: 'Explorador de Archivos',
    description: 'Navegación estilo Obsidian con estructura de árbol, menús contextuales y búsqueda rápida.',
  },
  {
    icon: Image,
    title: 'Gestión de Imágenes',
    description: 'Soporte para URLs externas, wiki-links embebidos y selector de archivos nativo.',
  },
  {
    icon: GitBranch,
    title: 'Integración Git',
    description: 'Clone, pull, push y commit directamente desde la aplicación con autenticación SSH.',
  },
  {
    icon: Terminal,
    title: 'Terminal Integrada',
    description: 'Ejecuta comandos PowerShell desde la barra de estado con historial de comandos.',
  },
  {
    icon: Sun,
    title: 'Temas',
    description: 'Modo claro y oscuro con persistencia de preferencias en localStorage.',
  },
]

const quickLinks = [
  { href: '/docs/installation', label: 'Installation Guide', icon: ArrowRight },
  { href: '/docs/shortcuts', label: 'Keyboard Shortcuts', icon: ArrowRight },
  { href: '/docs/faq', label: 'FAQ', icon: ArrowRight },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8">
              Editor de escritorio de Markdown con integración Git. 
              Inspirado en Obsidian, construido para desarrolladores y escritores.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Todo lo que necesitas para editar y gestionar tus documentos Markdown
            </p>
          </div>
